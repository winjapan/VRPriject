...
public class LadyPirateAttack : MonoBehaviour
{
   private Animator animator;
    ...
    public LadyPirateController lpCon;
    public Collider lpCol;
   ...
   public bool One;
    ...
    void Start()
    {
        ...
        lpCol = GameObject.Find("Bip001 R Finger213").GetComponent<BoxCollider>();
        One = false;
